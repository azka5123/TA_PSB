...
const MateriHTML4 = ({ navigation }) => {
  return (
    <SafeAreaView>
      <ScrollView style={{ backgroundColor: "#0096FF" }}>
        <View style={Style.container}>
          <Image style={Style.logo} source={require("../assets/logo.png")} />
          <Text style={Style.judul}>Membuat Komentar di HTML</Text>
          ...
          <Text style={Style.isimateri}>
            ...
            Biasanya paragraf ditssambahkan dengan beberapa atribut seperti align,
