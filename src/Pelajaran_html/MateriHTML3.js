...
const MateriHTML3 = ({ navigation }) => {
  return (
    <SafeAreaView>
      <ScrollView style={{ backgroundColor: "#0096FF" }}>
        <View style={Style.container}>
          <Image style={Style.logo} source={require("../assets/logo.png")} />
          <Text style={Style.judul}>Membuat Paragraf pada HTML</Text>
          ...
          <Text style={Style.subjudul}>- Membuat Paragraf di HTML</Text>
          <Text style={Style.isimateri}>
